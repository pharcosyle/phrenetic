   ...
   (services
    (-> '()
        ...
        (as-> $
          ...
          (if developer?
              (-> $
                  (he-emacs #:emacs (emacs-fully-loaded #:pgtk? #t) ; TODO maybe make this the he-emacs default
                            #:zsh-vterm? (eq? interactive-shell #:shell/zsh))
                  he-doom
