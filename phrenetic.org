...
***** Emacs packages
:PROPERTIES:
:header-args+: :tangle (meta-in-dir "packages/emacs.scm")
:END:
#+begin_src scheme
...
#+begin_src scheme :tangle (meta-in-dir "packages/doom-emacs.scm")
...
:PROPERTIES:
:header-args+: :tangle (meta-in-dir "packages/emacs-xyz.scm")
:END:
#+begin_src scheme
...
:PROPERTIES:
:header-args+: :tangle (meta-in-dir "packages/fonts.scm")
:END:
#+begin_src scheme
