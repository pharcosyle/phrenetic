...
(define-module (rde features wm)
  #:use-module (guix gexp)
  #:use-module (gnu home services)
  #:use-module ((gnu packages freedesktop) #:select (xdg-desktop-portal xdg-desktop-portal-wlr))
  #:use-module ((gnu packages glib) #:select (dbus))
  #:use-module ((gnu packages image) #:select (grim slurp swappy))
  #:use-module ((gnu packages linux) #:select (psmisc))
  ...
  #:use-module ((gnu packages wm) #:select (sway swaylock swaylock-effects waybar))
  #:use-module ((gnu packages xdisorg) #:select (wl-clipboard))
  #:use-module (rde home services wm)



  ;; TODO [sway-wip] Donno if I need these
  #:use-module (gnu system)
  #:use-module (gnu services)
...
(define (he-sway-screenshot svcs)
...
(define* (he-swayidle svcs
                      #:key
                      sway? ; TODO [sway-wip] maybe have this default to true
                      screen-locker
                      (lock-timeout 240)
                      extra-config)
  (append
