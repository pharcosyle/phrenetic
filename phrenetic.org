...
Use bleeding edge Emacs since development of the pgtk feature is ongoing. Use the github mirror since the canonical repo (https://git.savannah.gnu.org/git/emacs.git) doesn't allow shallow fetches.
#+begin_src scheme
(define-public (with-emacs-latest emacs)
  (-> emacs
      (with-git-commit #:upstream-version "29.0.50"
                       #:commit "7865b516c8dbff0e7872c746c7afca968ee2348a"
                       #:hash "1kiiwdr8lgmnb1mbfn8v0zlpy20nyiqsdx6fixd2fyqwaynk9asv")
