...
(defpoly
  :archive/melpa
  (get-recipe [p] (when-let [s (slurp-extant (str "/home/pharcosyle/.local/var/lib/doom-local/straight/repos/melpa" "/recipes/" p))]
                    (parse-melpa-recipe (edn/read-string s)))))
