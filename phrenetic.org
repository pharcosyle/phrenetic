    ...
    (-> barebones-os
        ...
        (as-> $
          ...
          (let* ((persist-dir stateless-persist-dir)
                 (subvols (btrfs-subvols #:statless? stateless?
                                         #:persist-dir persist-dir
                                         #:nix? nix?)))
            (-> $
...
|---------------+------------------------+---------------------+------------------------------|
| :user/primary | Krzysztof Baranowski   | :shell/default      | :session/gnome :session/sway |
| :user/aux     | Phil Coulson           | :shell/default      | :session/gnome :session/sway |
| :user/guest   | Speak Friend and Enter | :shell/default      | :session/gnome               |
...
| =:db/id=          | =:system/features=                                           |
|-------------------+--------------------------------------------------------------|
| :system/frostfire | :feature/disk-encryption :feature/stateless :feature/macbook |
