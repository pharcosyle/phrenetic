...
(defimpl
  :archive/melpa
  (get-recipe [p] (let [f (str "/home/pharcosyle/.local/var/lib/doom-local/straight/repos/melpa" "/recipes/" p)]
                    (when (file-exists? f)
                      (parse-melpa-recipe (edn/read-string (slurp f)))))))
