...
(define-module (ebullient home emacs)
  ...
  ;; #:use-module ((gnu packages emacs) #:select (emacs-minimal emacs-next-pgtk))
...
;; TODO see if I can quote e.g. '%default-modules in #:modules default like how %standard-phases is for phases
;; (define-public (emacs-with-C-source emacs)
;;   (package
;;     (inherit emacs)
;;     (arguments
;;      (substitute-keyword-arguments (package-arguments emacs)
;;        ((#:imported-modules imported-modules %glib-or-gtk-build-system-modules)
;;         `((guix build emacs-utils)
;;           ,@imported-modules))
;;        ((#:modules modules '((guix build glib-or-gtk-build-system)
;;                              (guix build utils)))
;;         `((guix build emacs-utils)
;;           ,@modules))
;;        ((#:phases phases '%standard-phases)
...
;;             (add-after 'unpack 'patch-C-source-directory
;;               (lambda _
;;                 (emacs-substitute-variables "lisp/emacs-lisp/find-func.el"
;;                   ("find-function-C-source-directory" #$(file-append (package-source emacs) "/src")))))))))
;;     (native-inputs
;;      (modify-inputs (package-native-inputs emacs)
;;        (prepend emacs-minimal)))))

;; (define-public cool-emacs-bro (emacs-with-C-source emacs-next-pgtk))
#+end_src
****** With =zstd=
