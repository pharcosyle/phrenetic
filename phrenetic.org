...
;; TODO commented out for now, it worked from the repl but it throws an error under some other circumstances because lokke isn't found? Whatever.
;; (use-modules ((gnu packages guile-xyz) #:prefix guile-xyz:))

;; (define-public lokke-new
;;   (let ((pkg guile-xyz:lokke))
;;     (package
;;       (inherit pkg)
;;       (source
;;        (origin
...
;;                (commit "69a97ca5c6448d7a319cd175594ccf9f2a4a8bde")))
;;          (sha256
;;           (base32
