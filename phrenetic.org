...
#+begin_src scheme
(define from-git (@@ (flat packages emacs) emacs-from-git))
(define with-native-comp (@@ (flat packages emacs) emacs-with-native-comp))

(define-public emacs-29-pgtk+native-comp
  (from-git
   (with-native-comp emacs-next-pgtk gcc-11 'full-aot)
