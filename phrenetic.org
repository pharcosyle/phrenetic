...
mkdir -p ~/.config/guix
cp ~/projects/phrenetic/exuberant/he/solitude/solitude-channels-lock ~/.config/guix
guix pull
hash guix
...
guix system --load-path=. init exuberant/os/frostfire.scm /mnt
#+end_src
**** Post-installation
#+begin_src sh
...
(define-module (ebullient home doom-inputs)
...
(define-module (penitent datomic)
  #:use-module (guix build-system copy)
  #:use-module (guix download)
  #:use-module (guix gexp)
  #:use-module (guix packages)
...
#+end_src
*** \
#+begin_src gitignore :tangle (meta-in-dir "mendicant/.gitignore")
*
#+end_src
** Emacs Lisp
:PROPERTIES:
:header-args+: :tangle (meta-in-dir "tangential/utils.el")
:END:
#+begin_src elisp
...
#+begin_src gitignore :tangle (meta-in-dir "tangential/.gitignore")
*
#+end_src
* Configurations
:PROPERTIES:
