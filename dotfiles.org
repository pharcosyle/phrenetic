...
(use-package! org-persist
  :defer t
  :init
  (message (concat "Is the org-persist index loaded yet? " (if org-persist--index "yes" "no"))) ; TODO remove this once I restart and know the answer is "no"
...
(use-package! guix-packaging
  ...
  :init
  (after! yasnippet
    (prependq! yas-snippet-dirs (expand-file-name "snippets/" (file-name-directory (locate-library "guix-packaging")))))) ; TODO not sure but assuming this is necessary
#+end_src
*** Packages
...
(package! guix-packaging ; REVIEW trying out
  :recipe (:host github :repo "ryanprior/emacs-guix-packaging")
  :pin "e843088252467db3c8a09de40ae9a62050196a0e")
