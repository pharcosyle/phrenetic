...
|---------------+------------------------+------------------------+---------------------+------------------------------|
| :user/primary | 'nonguix 'flat         | Krzysztof Baranowski   | :shell/default      | :session/gnome :session/sway |
| :user/aux     | 'nonguix 'flat         | Phil Coulson           | :shell/default      | :session/gnome :session/sway |
| :user/guest   | 'nonguix               | Speak Friend and Enter | :shell/default      | :session/gnome               |
...
(get-system-channels #:system/frostfire)
#+end_src
...
| =:db/id=      | =:user/email=            |
|---------------+--------------------------|
| :user/primary | pharcosyle@gmail.com     |
| :user/aux     | pharcosyle+aux@gmail.com |
| :user/guest   |                          |
...
(get-home-channels #:user/primary)
#+end_src
**** Channels lock
