...
#+end_src
** Pipewire
- REVIEW Using a patch for a newer pipewire because it's available and why not, remove this when updated (and wireplumber is added) in Guix.
