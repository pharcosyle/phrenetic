...
#+begin_src scheme
(define-system-comp (basics os #:key host-name timezone locale keyboard-layout)
  (host-name host-name)
  (timezone timezone)
  (locale locale)
...
*** Boot
#+begin_src scheme
(define-system-comp (boot os #:key label target)
...
#+begin_src scheme
(define-system-comp (initial-services os #:key desktop?)
  (services
   (append (if desktop?
               %desktop-services
               %base-services)
...
*** Linux nonfree
#+begin_src scheme
(define-system-comp (linux-nonfree os #:key substitutes?)
  (kernel linux)
...
(define-system-comp (disk-encryption os #:key source-uuid target encrypted-mount-points)
...
(define-system-comp (stateless os #:key persist-dir bluetooth?)
...
(define-system-comp (users os #:key who bluetooth?)
...
(define-system-comp (hidpi-console-font os)
...
(define-system-comp (macbook os #:key bluetooth?)
...
*** Custom WM
#+begin_src scheme
(define-system-comp (custom-wm os #:key package-name desktop-name executable)
...
#+begin_src scheme
(define-system-comp (miscellany os #:key backlight-control? nix? bluetooth?)
  (packages
