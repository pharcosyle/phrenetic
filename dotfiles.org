...
*** Boot
#+begin_src scheme
(define* (boot os #:key label target kbl)
  (operating-system
    (inherit os)
  ...
  (operating-system
    ...
    (initrd (lambda (file-systems . rest)
              (apply (operating-system-initrd os) file-systems
                     ...
                     rest)))
    (file-systems
     (stateless-file-systems persist-dir (operating-system-file-systems os)))
    (services
     (append
      (operating-system-user-services os)
      (list
...
**** File systems
#+begin_src scheme
(define (stateless-file-systems persist-dir file-systems)
  (map (lambda (fs)
...
(define-system-comp (btrfs #:key label subvols dependencies)
  (file-systems
   (append
    (map (match-lambda
           ((subvol mount-point)
