...
(specifications->manifest
 '("btrfs-progs" ; TODO "depends on"/"exists because of" the stateless module. Maybe it should be in some "system administration" section of Home config
   ...
   "flatpak"
   "xdg-desktop-portal" ; For flatpak. Not sure how useful it'll be without a full-er desktop environment.
   "xdg-desktop-portal-wlr" ; For flatpak. Not sure how useful it'll be without a full-er desktop environment.
