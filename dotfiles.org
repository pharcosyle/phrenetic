...
(define gdm-configuration-xorg (@@ (gnu services xorg) gdm-configuration-xorg))
#+end_src
#+begin_src scheme
...
**** Update Xorg fn
#+begin_src scheme
(define (update-gdm-xorg services xorg-update-fn)
  ((update-xorg
    gdm-service-type
    (lambda (config)
      (gdm-configuration
       (inherit config)
       (xorg-configuration
        (xorg-update-fn (gdm-configuration-xorg config))))))
   services))
#+end_src
*** Xorg
      ...
      (as-> $
        (if desktop?
            (-> $
                ...
                (as-> $
                  (let ((update-xorg-fn update-gdm-xorg))
                    (-> $
    ...
    (list (service-extension home-profile-service-type
          ...
          (service-extension home-bash-service-type
                             (const (home-bash-extension
                                     ;; TODO Might be nice to make this a `local-file' and src block
                                     (bashrc (list (plain-file "direnv-hook"
