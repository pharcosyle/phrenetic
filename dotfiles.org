...
(define-public default-login-shell #:bash)
#+end_src
** Channels
...
*** Shells
#+begin_src scheme
(define* (he-shells svcs #:key login-shell interactive-shell direnv?)
  (append
   (filter
    service?
    (let ((want-shell? (lambda (shell)
                         (memq shell (list login-shell interactive shell)))))
      (list
       (when (want-shell? #:bash)
       ...
       (when (not (eq login-shell interactive-shell))
         (simple-service 'set-shell-env-var
       ...
       (when direnv?
         (case interactive-shell
           ;; ((#:bash) (service he-bash-direnv-service-type))
           ((#:zsh) (service he-zsh-direnv-service-type)))))))
   svcs))
#+end_src
...
***** Zsh
#+begin_src scheme
(define he-zsh-direnv-service-type
  (service-type
   (name 'he-zsh-direnv)
   (extensions
    (list
   ...
   (services
    (-> '()
        (he-shells #:login-shell login-shell
                   ...
                   #:direnv? #t)
        (he-emacs #:zsh-vterm? (eq? interactive-shell #:zsh)
