...
(specifications->manifest
 '("ungoogled-chromium"
   ...
   "icedtea" ; For clojure-tools ; TODO can I make this a non-propagated input to "clojure-tools" or is that a bad idea / a pain?
...
;;   :init
;;   (after! yasnippet
;;     (add-to-list 'yas-snippet-dirs (expand-file-name "snippets/" (file-name-directory (locate-library "guix-packaging"))))))
#+end_src
***** Dired-X :UI:hidden:
#+begin_src elisp
(use-package! dired-x
  :defer t
  :init
  ;; Don't hide things by default, remove the Doom module's hook.
