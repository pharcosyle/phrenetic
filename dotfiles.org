  ...
  (wm os
      ...
      #:services (append ((feature-system-services-getter (feature-sway)) (rde-config
                                                                           (features
                                                                            (list
                                                                             (feature
                                                                              (name 'dummy-provide-old-alacritty)
                                                                              ;; (values `((default-terminal . ,(file-append package "/bin/alacritty"))))
                                                                              (values '((default-terminal . "/gnu/store/whb3c3brk214w9y1zj038jxsscdgf4qw-alacritty-0.9.0/bin/alacritty"))))))))
                         (if laptop?
