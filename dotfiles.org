...
(define-module (ebullient home components)
  ...
  #:use-module (rde features)
  #:use-module ((rde features linux) #:select (feature-pipewire))
  #:use-module ((ebullient home wm) #:select (feature-sway))
  #:use-module (ebullient utils)
...
#+end_src
** wm.scm TEMP
#+begin_src scheme :tangle (in-tangle-dir "wm.scm")
(define-module (ebullient home wm)
  #:use-module (rde features)
	   ...
	   (layout-config  (if (and add-keyboard-layout-to-config? kb-layout)
           ...
           (default-terminal
             (get-value 'default-terminal config
                        "/gnu/store/whb3c3brk214w9y1zj038jxsscdgf4qw-alacritty-0.9.0/bin/alacritty"))
