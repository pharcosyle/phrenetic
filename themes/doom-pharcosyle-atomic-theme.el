;;; doom-pharcosyle-atomic-theme.el --- inspired by Atom One Dark -*- no-byte-compile: t; -*-
(require 'doom-themes)
...
;;
(def-doom-theme doom-pharcosyle-atomic
  ...
  ((bg         '("#282c34" nil       nil            ))
   ...
   (violet     '("#fec0cb" "#a9a1e1" "magenta"      ))
   (cyan       '("#75E0F9" "#46D9FF" "brightcyan"   ))
   (dark-cyan  '("#5699AF" "#5699AF" "cyan"         ))

   ;; (dark-red   '("#cf8191" "#ff6655" "red"          ))
   ...
   (selection      dark-blue)
   (builtin        blue)
   (comments       (if doom-one-brighter-comments dark-cyan "#63677F"))
...
;;; doom-pharcosyle-atomic-theme.el ends here
