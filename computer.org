...
(define-module (solitude)
  ...
  #:use-module ((emacs-temp) #:select (emacs-desktop-environment-temp))
...
(define solitude
  (home-environment
   ...
   (packages (list spartan
                   ...
                   (list gtk+ "bin") ; For `gtk-launch' for counsel-linux-app ; TODO make this an input to a/the counsel package
...
#+end_src
*** emacs-temp
#+begin_src scheme :tangle (in-tangle-dir "emacs-temp.scm")
(define-module (emacs-temp)
...
xkbcomp -I$HOME/myxkb $HOME/myxkb/current_setxkbmap_print $DISPLAY
 ...
 (list
  ...
  (specifications->manifest
   '("ungoogled-chromium"
     ...
     "gtk+:bin" ; For `gtk-launch' for counsel-linux-app ; TODO make this an input to a/the counsel package
