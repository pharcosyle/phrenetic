...
;; TODO Probably getting rid of this but if I keep it make this a reference to emacs-variant
(specifications->manifest
 '("emacs-native-comp"))
#+end_src
** Channels
...
# TODO these
# TODO [2021-09-24 Fri] see https://github.com/emacs-mirror/emacs/blob/master/etc/NEWS bit about "as 'xft' is no longer a valid backend when using Cairo"
...
(use-package! exwm
  ...
  ;; WIP
  ;; (add-hook 'exwm-mode-hook #'doom-mark-buffer-as-real-h)) ; TODO any chance this is causing those XELB errors I'm (suddenly?) experiencing? Reproduce by triggering a download window in chromium and then doing anything. Also if I'm keeping this remember that I have to do something special to make saving the perspective not flub
#+end_src
***** dunstrc :theming:
