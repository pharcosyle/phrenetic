...
(define solitude
  (home-environment
   ;; (packages (list htop))
   (packages (list (with-emacs-native-comp spartan)
                   (with-emacs-native-comp doom-emacs-temp)
                   ;; TODO temp emacs stuff
                   (with-emacs-native-comp (specification->package "emacs-exwm"))
                   (with-emacs-native-comp emacs-desktop-environment-temp) ; TODO donno where this should really go
...
export PATH="/gnu/store/4fzpm7br2c80qyph97rzxfa7y0c5wsva-emacs-native-comp-28.0.50-180.e68bc86/bin${PATH:+:}$PATH" # TODO remove this hardcoding when I can add emacs to my guix home packages without eating up all my inodes
