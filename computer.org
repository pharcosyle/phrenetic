...
(define solitude
  (home-environment
   ;; (packages (list htop))
   (packages (list ;; emacs-variant ; TODO add this back when I can do so without eating up all my inodes. Also remove hardcoded PATH in bash_profile
...
export PATH="/gnu/store/4fzpm7br2c80qyph97rzxfa7y0c5wsva-emacs-native-comp-28.0.50-180.e68bc86/bin${PATH:+:}$PATH" # TODO remove this hardcoding when I can add emacs to my guix home packages without eating up all my inodes. Also add back the emacs varint package in guix-home packages
