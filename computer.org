...
(define-module (solitude)
  ...
  #:use-module ((spartan-executable) #:select (spartan-executable)))
...
- TODO temporarily hardcoding path to emacs-native in startup-script to avoid a rebuild
  Uncoment the ~package-input-rewriting~-wrapped spartan-executable in home config when I get rid of this hardcoding
#+begin_src scheme :tangle (in-tangle-dir "spartan-executable.scm")
(define-module (spartan-executable)
  #:use-module ((guix packages) #:select (package))
  #:use-module ((guix build-system trivial) #:select (trivial-build-system))
...
exec dbus-launch --exit-with-session /gnu/store/i77clb2i8lxdxfbr2zl232d0wk471dvh-emacs-native-comp-28.0.50-175.8b49e99/bin/emacs -mm -l ~/Projects/dotfiles/gen/home/desktop.el # --debug-init")
...
* Manifests
** omni
#+begin_src scheme :tangle (in-tangle-dir "omni.scm")
