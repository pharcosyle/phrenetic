...
(use-package! exwm
  ...
  ;; WIP
  (add-hook 'exwm-mode-hook #'doom-mark-buffer-as-real-h)) ; TODO any chance this is causing those XELB errors I'm (suddynely?) experiencing? Also if I'm keeping this remember that I have to do something special to make saving the perspective not flub
#+end_src
***** dunstrc :theming:
