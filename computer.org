...
*** init.el
:PROPERTIES:
:header-args+: :tangle gen/doom/init.el :lexical t
:END:
**** Header
#+begin_src elisp
;;; -*- lexical-binding: t; -*-
...
*** config.el
:PROPERTIES:
:header-args+: :tangle gen/doom/config.el :lexical t
:END:
**** Header
#+begin_src elisp
;;; -*- lexical-binding: t; -*-
...
;; TODO try to move this into an org `:init' block or something, it doesn't belong up here in "Private".
...
***** Time :UI:
#+begin_src elisp
;; TODO see whether my startup time suffers because of this (or the `use-package!' for battery-mode)
(use-package! time
  :config
...
#+end_src
*** packages.el
#+begin_src elisp :tangle gen/doom/packages.el
;; -*- no-byte-compile: t; -*-
...
#+end_src
*** Theme :UI:theming:
#+begin_src elisp :tangle gen/doom/themes/doom-nuclear-theme.el.el :lexical t
