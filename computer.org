...
#+end_src
** Frostfire
#+begin_src scheme :tangle gen/computer/system/frostfire.scm :noweb yes
...
#+end_src
** Solitude
#+begin_src scheme :tangle gen/computer/home/solitude.scm :noweb yes
...
*** init.el
:PROPERTIES:
:header-args+: :tangle gen/.config/doom/init.el
:END:
**** Header
#+begin_src elisp
;;; -*- lexical-binding: t; -*-
...
*** config.el
:PROPERTIES:
:header-args+: :tangle gen/.config/doom/config.el
:END:
**** Header
#+begin_src elisp
;;; -*- lexical-binding: t; -*-
...
#+end_src
*** Theme :UI:theming:
#+begin_src elisp :tangle gen/.config/doom/themes/doom-nuclear-theme.el
...
#+begin_src elisp :tangle gen/desktop.el
;;; -*- lexical-binding: t; -*-
